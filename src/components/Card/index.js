...
const Cards = ({ id, title, price, image, linkBuy }) => {
    let cardTarget
    ...
    const addStyling = () => {
        cardTarget.parentElement.style.backgroundColor = "#81aa66"
        ...
        <Card key={id} style={{ width: '20rem', borderRadius:"18px", border: "0" , backgroundColor: "transparent", transition:"transform 0.1s", color: "#fff" }}>
            ...
            <Card.Body className="d-none">
                <Card.Link style={{textDecoration: "none",
                                    ...
                                    position:"absolute",
                                    left: "130px",
                                    bottom: "10px"}} href="#">Comprar</Card.Link>
            </Card.Body>
        </Card>
    )
}
